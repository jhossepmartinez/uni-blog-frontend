            ...
            <header className="bg-white border-b-2">
                ...
                {nav_is_visible && (
                    <div class="lg:hidden" role="dialog" aria-modal="true">
                        <div class="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-4 py-5 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
                            <div class="flex items-center justify-end">
                                <button type="button" class="-m-2.5 rounded-md p-2.5 text-gray-700" onClick={nav_visibility_handler}>
